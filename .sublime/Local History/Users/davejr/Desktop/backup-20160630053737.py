...
def do():
	...
	# ==================================================#
	#	Property / Image Model Construction
	# ==================================================#
	propertyid = 1
	imageid = 1
	for house in JSON:
		...
		for key, value in house.iteritems():
			...
			if field == "img":
				...
				for img in imgs:
					...
					image_db.save()
					imageid += 1
			elif field in ["bedrooms", "bathrooms", "acres", "latitude", "longitude"]:
...
def delete_all():
	...
	while Image.objects.count():
		ids = Image.objects.values_list('pk', flat=True)[:100]
