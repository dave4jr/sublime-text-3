...
urlpatterns += [
    ...
    url(r'^login/$', views.main, {"template": "login.html"}, name="login"),
    # url(r'^products/$', views.main, {"template": "products.html"}, name="products"),
    url(r'^services/$', views.main, {"template": "services.html"}, name="services"),
    url(r'^products/$', views.main, {"template": "products_parallax.html"}, name="products"),
