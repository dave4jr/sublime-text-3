...
def checkout(request, template):
	...
	if request.POST == "POST":
		form = CheckoutForm(request.POST, instance=reservation, initial={'checkout_mileage': reservation.bike.current_mileage})
		if form.is_valid():
			form.save
			return redirect("checkout")
	else:
		form = CheckoutForm(instance=reservation, initial={'checkout_mileage': reservation.bike.current_mileage})
	context = {
		"CheckoutForm": form,
