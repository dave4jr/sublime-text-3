...
def main(request, template):
	...
	if request.method == "POST":
		...
		for id in id_array:
			...
			if node == "Check-In" or node == "Check-Out" or node=="Files" or node=="Bikes":
				messages.add_message(request, messages.ERROR, 'Checkin, Checkout, Files, and Bikes folders are used to keep system files and can not be deleted.')
