...
def checkout(request, template, pk):
	...
	return render(request, template, {"reservation":reservation, "CheckoutForm": checkout_form, "BikeForm":checkout_bike_form } )
...
def checkout_condition(request, template, pk):
	...
	return render(request, template, {"reservation":reservation, "CheckoutConditionForm": checkout_condition_form, "BikeForm":checkout_condition_bike_form } )
