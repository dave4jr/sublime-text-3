...
class CheckoutForm(forms.ModelForm):
	class Meta:
		model = Reservation
		fields = ("customer", "checkout_datetime_actual", "notes")
...
class CheckoutConditionForm(forms.ModelForm):
	class Meta:
		model = Reservation
		fields = ("customer", "checkout_datetime", "checkin_datetime", "checkout_img_1", "checkout_img_2", "checkout_img_3", "checkout_img_4", "checkout_img_5", "checkout_img_6","notes")
