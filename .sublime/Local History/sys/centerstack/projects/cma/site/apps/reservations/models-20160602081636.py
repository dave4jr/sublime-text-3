...
class Workflow(wf.Workflow):
	...
	transitions = (
		...
		('reset', ("pending_deposit", "reserved", "checked_out", "checked_in", "damaged", "pending_damage_payment", "closed"), 'pending_deposit'),
	)
...
# ==================================================#
	def bike_deposit(self):
		if self.bike is None:
			...
			return (preference.bike_deposit * self.duration)
		else:
			return 0
