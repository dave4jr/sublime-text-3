...
urlpatterns += [
	...
	url(r'^checkout_condition/$', reservation_views.checkout, {"template":"processing/checkout_condition.html"}, name="checkout_condition"),
	url(r'^checkout_membership/$', reservation_views.checkout, {"template":"processing/checkout_membership.html"}, name="checkout_membership"),
	url(r'^checkout_liability/$', reservation_views.checkout, {"template":"processing/checkout_liability.html"}, name="checkout_liability"),
