...
# ==================================================#
	...
	checkout_condition = models.BooleanField(default=0, blank=True)
	checkout_membership = models.BooleanField(default=0, blank=True)
	checkout_liability = models.BooleanField(default=0, blank=True)
