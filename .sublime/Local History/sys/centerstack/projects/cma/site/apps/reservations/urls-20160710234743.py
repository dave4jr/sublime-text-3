...
urlpatterns += [
	...
	url(r'^checkout_condition/(?P<pk>\d+)/$', reservation_views.checkout_agreement_forms, {"template":"processing/checkout_condition.html"}, name="checkout_condition"),
	url(r'^checkout_membership/(?P<pk>\d+)/$', reservation_views.checkout_agreement_forms, {"template":"processing/checkout_membership.html"}, name="checkout_membership"),
	url(r'^checkout_liability/(?P<pk>\d+)/$', reservation_views.checkout_agreement_forms, {"template":"processing/checkout_liability.html"}, name="checkout_liability"),
]
