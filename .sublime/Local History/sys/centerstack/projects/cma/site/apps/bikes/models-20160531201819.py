...
class Bike(models.Model):
	...
	insurance_price = models.IntegerField(verbose_name="Insurance Price", blank=True, null=True)
	deposit_factor = models.IntegerField(verbose_name="Deposit Factor", blank=True, null=True, default=50)
	damage_deposit = models.IntegerField(verbose_name="Damage Deposit", blank=True, null=True, default=1500)
