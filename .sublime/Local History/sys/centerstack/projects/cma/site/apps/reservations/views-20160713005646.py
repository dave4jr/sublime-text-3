...
def checkout(request, template, pk):
	...
	if request.method == "POST":
		...
		data={"checkout_mileage": reservation.bike.current_mileage, "checkout_datetime_actual": reservation.checkout_datetime, "checkout_notes": reservation.notes }
		form = CheckoutForm(data, instance=reservation)
