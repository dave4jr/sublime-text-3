    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_mileage', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('oil_change_mileage', models.IntegerField(blank=True, default=models.IntegerField(blank=True, default=0, null=True), null=True)),
                ('air_filter_clean_date', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('air_filter_clean_mileage', models.IntegerField(blank=True, default=models.IntegerField(blank=True, default=0, null=True), null=True)),
                ('sprocket_and_chain_change_date', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('sprocket_and_chain_change_mileage', models.IntegerField(blank=True, default=models.IntegerField(blank=True, default=0, null=True), null=True)),
                ('valve_adjustment_date', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('valve_adjustment_mileage', models.IntegerField(blank=True, default=models.IntegerField(blank=True, default=0, null=True), null=True)),
                ('brake_fluid_change_date', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('brake_fluid_change_mileage', models.IntegerField(blank=True, default=models.IntegerField(blank=True, default=0, null=True), null=True)),
                ('coolant_change_date', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('coolant_change_mileage', models.IntegerField(blank=True, default=models.IntegerField(blank=True, default=0, null=True), null=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('mileage_per_oil_change', models.IntegerField(blank=True, default=4000, null=True)),
                ('mileage_per_air_filter_clean', models.IntegerField(blank=True, default=6000, null=True)),
                ('mileage_per_sprocket_and_chain_change', models.IntegerField(blank=True, default=20000, null=True)),
                ('mileage_per_valve_adjustment', models.IntegerField(blank=True, default=15000, null=True)),
                ('mileage_per_brake_fluid_change', models.IntegerField(blank=True, default=15000, null=True)),
                ('mileage_per_coolant_change', models.IntegerField(blank=True, default=20000, null=True)),
            ],
        ),
        migrations.CreateModel(
