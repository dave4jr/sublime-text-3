...
#	Stripe
# ==================================================#
STRIPE_SECRET_KEY = os.environ.get("STRIPE_SECRET_KEY", "sk_test_DcjbI3p4rPtqgjtpvweYjXsE")
STRIPE_PUBLIC_KEY = os.environ.get("STRIPE_PUBLIC_KEY", "pk_test_6eKlYSUJZWIJnmPzHxp3qAYJ")
