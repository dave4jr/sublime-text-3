...
class Preference(models.Model):
	...
	calendar_color_tour = ColorField(default='#fff', null=True)
	calendar_color_class = ColorField(default='#fff', null=True)
	calendar_color_bike = ColorField(default='#fff', null=True)
	calendar_color_storage = ColorField(default='#fff', null=True)
	datepicker_color = ColorField(default='#fff', null=True)
