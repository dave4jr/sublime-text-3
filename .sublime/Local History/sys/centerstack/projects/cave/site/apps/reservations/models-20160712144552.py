...
from inventory.models import Accessories
...
STORAGE_BIKE_NUM_CHOICES = (("1 Bike", "1 Bike"),("2 Inventory", "2 Inventory"),("3 Inventory", "3 Inventory"),("4 Inventory", "4 Inventory"),("5 Inventory", "5 Inventory"))
...
# ==================================================#
	...
	checkout_printed = models.CharField(max_length=100, null=True, blank=True)
	...
	checkout_condition_complete = models.BooleanField(default=0, blank=True)
	checkout_bike_license_plate = models.CharField(max_length=15, null=True, blank=True)
	checkout_membership_complete = models.BooleanField(default=0, blank=True)
	checkout_liability_complete = models.BooleanField(default=0, blank=True)
	...
	checkout_file_created = models.DateTimeField(auto_now_add=True, null=True, blank=True)
	checkout_file_modified = models.DateTimeField(auto_now=True, null=True, blank=True)
...
# 	member = Member.objects.get(pk=reservation.pk)
# 	if reservation.send_confirmation_email:
# 		html_content = render_to_string('email/confirmation.html', {'reservation': reservation, 'bike':bike, 'member':member})
