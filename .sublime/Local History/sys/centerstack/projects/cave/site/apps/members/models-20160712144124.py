...
#*  Client:		CMA
#*  Description:	customers/models.py
#*=========================== #
...
DL_STATE_CHOICES = (("Alabama", "Alabama"), ("Alaska", "Alaska"), ("Arizona", "Arizona"), ("Arkansas", "Arkansas"), ("California", "California"), ("Colorado", "Colorado"), ("Connecticut", "Connecticut"), ("Delaware", "Delaware"), ("Florida", "Florida"), ("Georgia", "Georgia"), ("Hawaii", "Hawaii"), ("Idaho", "Idaho"), ("Illinois", "Illinois"), ("Indiana", "Indiana"), ("Iowa", "Iowa"), ("Kansas", "Kansas"), ("Kentucky", "Kentucky"), ("Louisiana", "Louisiana"), ("Maine", "Maine"), ("Maryland", "Maryland"), ("Massachusetts", "Massachusetts"), ("Michigan", "Michigan"), ("Minnesota", "Minnesota"), ("Mississippi", "Mississippi"), ("Missouri", "Missouri"), ("Montana", "Montana"), ("Nebraska", "Nebraska"), ("Nevada", "Nevada"), ("New Hampshire", "New Hampshire"), ("New Jersey", "New Jersey"), ("New Mexico", "New Mexico"), ("New York", "New York"), ("North Carolina", "North Carolina"), ("North Dakota", "North Dakota"), ("Ohio", "Ohio"), ("Oklahoma", "Oklahoma"), ("Oregon", "Oregon"), ("Pennsylvania", "Pennsylvania"), ("Rhode Island", "Rhode Island"), ("South Carolina", "South Carolina"), ("South Dakota", "South Dakota"), ("Tennessee", "Tennessee"), ("Texas", "Texas"), ("Utah", "Utah"), ("Vermont", "Vermont"), ("Virginia", "Virginia"), ("Washington", "Washington"), ("West Virginia", "West Virginia"), ("Wisconsin", "Wisconsin"), ("Wyoming", "Wyoming"), )
...
RIDING_ABILITY_CHOICES = (('Beginner', 'Beginner'), ('Intermediate', 'Intermediate'), ('Advanced', 'Advanced'), ('Expert', 'Expert'))
...
class Customer(models.Model):
	...
	state = models.CharField(max_length=20, null=True, choices=STATE_CHOICES, default="Colorado")
	zipcode = models.CharField(max_length=5, blank=True, null=True)
	country = models.CharField(max_length=30, null=True, choices=COUNTRY_CHOICES, default="United States")
	...
	driver_license_number = models.CharField(verbose_name="DL Number", max_length=20, blank=True, null=True)
	driver_license_state = models.CharField(verbose_name="DL State", max_length=20, null=True, choices=DL_STATE_CHOICES, default="Colorado")
	driver_license_photocopy = models.ImageField(upload_to='customers/', blank=True, null=True)
	motorcycle_license = models.BooleanField(default=False)
	current_motorcycle = models.CharField(max_length=50, blank=True, null=True)
	riding_ability = models.CharField(max_length=20, null=True, choices=RIDING_ABILITY_CHOICES, default="3")
	tshirt_size = models.CharField(max_length=20, null=True, choices=TSHIRT_SIZE_CHOICES, default="XL")
	mailing_list = models.BooleanField(verbose_name="Mailing List?", default=False)
	referral_source = models.ForeignKey(ReferralSource, null=True, blank=True)
	return_customer = models.BooleanField(verbose_name="Returning?", default=False)
	notes = models.TextField(null=True, blank=True)

	def full_address(self):
		return "%s %s, %s %s %s" % (self.street, self.city, self.state, self.zipcode, self.country )
