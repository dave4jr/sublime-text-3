...
class Member(models.Model):
	...
	driver_license_photocopy = models.ImageField(upload_to='members/', blank=True, null=True)
	...
	return_member = models.BooleanField(verbose_name="Returning?", default=False)
