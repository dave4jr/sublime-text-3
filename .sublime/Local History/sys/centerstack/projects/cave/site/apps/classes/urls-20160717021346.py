...
urlpatterns = [
	...
	url(r'^new/$', class_views.main, {"template":"edit/class_edit.html"}, name="class_new"),
	url(r'^delete/$', class_views.delete, {"template":"classes.html"}, name="class_delete"),
	url(r'^edit/(?P<pk>\d+)/$', class_views.edit, {"template":"edit/class_edit.html"}, name='class_edit'),
]
