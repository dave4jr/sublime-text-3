...
for offset in offset_range:
	...
	#	Search
	# ====================================== #
	SELECT_LIST = HEADER = ["Acres","Bathrooms","Bedrooms","City","RESICOMM","County","RESIEXTE","RESIHTCO","RESIHOA","RESIHOAP","RESIHOAD","RESIINC1","RESIINC2","RESIINC3","RESIINTE","RESIKITC","Latitude","ListingAgentFullName","ListingDate","MLNumber","ListingPrice","ListingRid","Longitude","MarketingRemarks","RESIPARK","PropertyType","Region","RESIROOM","Style","SquareFootage","State","Status","StatusDate","StreetName","StreetNumber","StreetSuffix","RESISTYL","Unit","RESIVIEW","YearBuilt","ZipCode","RESIWTRD","RESILEVL"]
