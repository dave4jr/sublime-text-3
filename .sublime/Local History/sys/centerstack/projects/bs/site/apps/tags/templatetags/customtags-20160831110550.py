...
def boxed_letter(value, color):
	if value is not None:
		...
		html = "<span style='padding: 3px 8px; margin-right: 3px; text-transform: uppercase; color: #fff; background: %s; border-radius: 4px; font-size: 20px; font-weight: 600;'>%s</span>%s" %  (color, first_letter, rest_of_letters)
...
#	Remove Comma
# ====================================== #
@register.filter(name='strip_comma')
...
#	Remove Comma
# ====================================== #
@register.filter(name='comma_space')
