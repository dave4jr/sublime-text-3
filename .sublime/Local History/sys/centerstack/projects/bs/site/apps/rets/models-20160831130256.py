...
class Property(models.Model):
	...
	listingagentnumber 	= models.CharField(max_length=500, null=True, blank=True)
	listingdate 			= models.CharField(max_length=12, null=True, blank=True)
	...
	resiinc1 			= models.CharField(max_length=500, null=True, blank=True)
	resiinc2 			= models.CharField(max_length=500, null=True, blank=True)
	resiinc3 			= models.CharField(max_length=500, null=True, blank=True)
	resiinte 			= models.CharField(max_length=500, null=True, blank=True)
	resikitc 			= models.CharField(max_length=500, null=True, blank=True)
	...
	statusdate 			= models.CharField(max_length=500, null=True, blank=True)
	...
	subtype1	 		= models.CharField(max_length=500, null=True, blank=True)
	subtype2	 		= models.CharField(max_length=500, null=True, blank=True)
	subtype3	 		= models.CharField(max_length=500, null=True, blank=True)
