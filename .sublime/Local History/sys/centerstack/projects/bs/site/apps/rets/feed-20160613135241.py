...
#	Search
# ====================================== #
SELECT_LIST = HEADER = ["Acres","Area","Bathrooms","Bedrooms","City","RESICOMM","County","RESIEXTE","RESIHTCO","RESIHOA","RESIHOAP","RESIHOAD","RESIINC1","RESIINC2","RESIINC3","RESIINTE","RESIKITC","Latitude","ListingAgentFullName","ListingAgentMLSID","ListingAgentNumber","ListingCoAgentFullName","ListingCoAgentMLSID","ListingDate","MLNumber","ListingOfficeMLSID","ListingOfficeName","ListingPrice","ListingRid","Longitude","LotMeasurement","LotSquareFootage","MarketingRemarks","RESIPARK","PropertyType","Region","RESIROOM","Style","SquareFootage","State","Status","StatusDate","StreetName","StreetNumber","StreetSuffix","RESISTYL","Unit","RESIVIEW","YearBuilt","ZipCode"]
