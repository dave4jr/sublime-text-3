...
class Property(models.Model):
	...
	city 				= models.CharField(max_length=100, null=True, blank=True, default="Bend")
	...
	subtype1	 		= models.CharField(max_length=100, null=True, blank=True)
	subtype2	 		= models.CharField(max_length=100, null=True, blank=True)
	subtype3	 		= models.CharField(max_length=100, null=True, blank=True)
	...
	keysearch 			= models.CharField(max_length=1000, null=True, blank=True)
