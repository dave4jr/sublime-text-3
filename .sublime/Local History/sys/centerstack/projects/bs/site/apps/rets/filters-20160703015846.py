...
#	Choices
# ====================================== #
BEDROOM_CHOICES = ((0, "1"), (1, "2"), (2, "3"), (3, "4"), (4, "5+"))
...
class PropertyFilter(django_filters.FilterSet):
	...
	squarefootage = django_filters.ChoiceFilter(choices=squarefootage, required=False)
	acres = django_filters.ChoiceFilter(choices=acres, required=False)
	...
	#	Search
	# ====================================== #
	streetname = django_filters.CharFilter(lookup_expr='icontains', required=False)
